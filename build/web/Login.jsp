<%-- 
    Document   : Login
    Created on : Jan 24, 2018, 5:43:44 PM
    Author     : SHUBHAM
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>SJ Attendance Manager</title>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="Checker" method="post" class="login-form">
                                                <input type="text" value="<%=user%>" name="user" hidden />
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">ID</label>
			                        	<input type="text" name="id" placeholder="Enter your ID or Username..." class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
